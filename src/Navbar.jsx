...
return (
    ...
    <div className="flex-none gap-2">
        ...
        <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52">
            <li>
            <a className={activeMenuItem === 'username' ? 'active' : ''} onClick={() => setActiveMenuItem('username')}>
                {content}
            </a>
            </li>
            <li>
                <a className={activeMenuItem === 'logout' ? 'active' : ''} onClick={() => setActiveMenuItem('logout')}>
                    Logout
                </a>
            </li>
        </ul>
